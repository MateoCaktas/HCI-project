...
title: "Deadpool"
slug: Deadpool
image: "./images/deadpoolslika.jpg"
ocjena: 9.8/10
zanr: Action
---
...
<div class="slike-post">
    <div>
        <figure class="figure1">
            <img class="slika-1-post" src="./images/deadpoolslika.jpg" alt="Title"/>
            <figcaption class="figure__caption">Batman Begins</figcaption>
        </figure>
    </div>
    <div>
        <figure class="figure2">
            <img class="slika-2-post" src="./images/deadpoolslika.jpg" alt="Title"/>
            <figcaption class="figure__caption">Scena 1</figcaption>
        </figure>
        </div>
        <div>
        <figure class="figure3">
            <img class="slika-3-post" src="./images/deadpoolslika.jpg" alt="Title"/>
